...
def test(pairs):
    # MANUALLY REPLACE THE "a + b + c + d" WITH A PYTHON EXPRESSION
    # CORRESPONDING TO YOUR ANSWER FROM Z3. If its correct, the test will print
    # 'Your program satisfies all IO pairs!'
    def program(a, b, c, d):
